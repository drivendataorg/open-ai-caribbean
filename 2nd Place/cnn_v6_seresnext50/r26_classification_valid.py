...
from cnn_v6_seresnext50.r17_classification_train_kfold_224 import *
...
def get_TTA_image_classification(img_orig):
    ...
    # delta_list = [100, 90, 80, 75, 70, 65, 60, 55, 50, 45, 40, 35, 30, 25, 20, 10, 5]
    for d in delta_list:
...
'''
TTA 32
Fold vrfd: 0 Accuracy: 0.827020 Log loss: 0.442020
Fold vrfd: 1 Accuracy: 0.843624 Log loss: 0.419887
Fold vrfd: 2 Accuracy: 0.831204 Log loss: 0.442911
Fold vrfd: 3 Accuracy: 0.842992 Log loss: 0.415385
Fold vrfd: 4 Accuracy: 0.842833 Log loss: 0.436001
Only verified validation stat Loss: 0.431246 Acc: 0.837525
'''
