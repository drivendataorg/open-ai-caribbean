...
MODELS_PATH_KERAS = MODELS_PATH + 'classification_densenet_169_224/'
...
def model_DenseNet169_multich(size, upd_ch):
    ...
    weights_cache_path = CACHE_PATH + 'model_DenseNet169_{}ch_imagenet_{}.h5'.format(upd_ch, size)
    if not os.path.isfile(weights_cache_path):
        model_ref = DenseNet169(include_top=False,
                          weights='imagenet',
                          input_shape=(size, size, ref_ch),
                          pooling='avg',)
        model_upd = DenseNet169(include_top=False,
                                   weights=None,
...
def create_keras_model(fold_number):
    ...
    train_ids_all, train_answ_all, valid_ids_all, valid_answ_all = get_kfold_split(KFOLD_NUMBER, seed=21)
    ...
    model_name = 'densenet169_224_fold_{}'.format(fold_number)
    optim_name = 'Adam'
    batch_size_train = 16
    batch_size_valid = 16
    ...
    model = model_DenseNet169_multich(224, 4)
...
'''
Train val
Fold 1: Ep 24: 339s 433ms/step - loss: 0.2584 - acc: 0.9014 - val_loss: 0.4472 - val_acc: 0.8345
Fold 2: Ep 18: 396s 506ms/step - loss: 0.2918 - acc: 0.8875 - val_loss: 0.4505 - val_acc: 0.8256
Fold 3: Ep 20: 441s 564ms/step - loss: 0.2806 - acc: 0.8912 - val_loss: 0.4309 - val_acc: 0.8390
Fold 4: Ep 27: 500s 639ms/step - loss: 0.2680 - acc: 0.8991 - val_loss: 0.4459 - val_acc: 0.8390
Fold 5: Ep 22: 336s 429ms/step - loss: 0.2819 - acc: 0.8935 - val_loss: 0.4453 - val_acc: 0.8341
Fold 6: Ep 16: 362s 462ms/step - loss: 0.2982 - acc: 0.8867 - val_loss: 0.4401 - val_acc: 0.8321
'''