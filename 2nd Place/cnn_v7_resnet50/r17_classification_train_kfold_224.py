...
def strong_aug(p=1.0):
    return Compose([
        ...
        RGBShift(p=0.9, r_shift_limit=(-20, 20), g_shift_limit=(-20, 20), b_shift_limit=(-20, 20)),
        ...
        ShiftScaleRotate(shift_limit=0.1, scale_limit=0.1, rotate_limit=45, p=0.9, border_mode=cv2.BORDER_REFLECT),
        OneOf([
...
def model_gen(size, upd_ch):
    ...
    required_layer_conv_name = 'conv0'
